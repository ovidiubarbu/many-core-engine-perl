...
=head2 send ( $data_ref )
   ...
   ## Workers set $self->{user_data} back to undef after processing.
   ##
   ## One cannot specify input_data, sequence, or user_tasks when wanting
   ## to use the "send" method. Workers begin processing immediately after
   ## receiving data.
