...
Below, a new instance is configured with all available options.
   ...
   my $mce = MCE->new(
      ...
      RS         => "\n>",               ## Default undef
          ...
          ## and file handles. MCE applies extra logic for RS beginning
          ## with a newline character; e.g. RS => "\n>". It chops the
          ## characters following the newline and prepends them to
          ## subsequent records. This is automatic when not slurping.
          ## Otherwise, the logic is applied to the first and last
          ## records only.
          ##
          ## use_slurpio => 0
          ##    Record 1:  >seq1 ... \n>   (to)   >seq1 ... \n
          ...
          ##    Last Rec:  seqN  ... \n           >seqN ... \n
          ##
          ## use_slurpio => 1 (chunks begin with > and end with \n)
          ##    Record 1:  >seq1 ... \n>   (to)   >seq1 ... \n>
          ##    Record 2:  seq2  ... \n>          seq2  ... \n>
          ##    Record 3:  seq3  ... \n>          seq3  ... \n>
          ##    Last Rec:  seqN  ... \n           seqN  ... \n
...
scalar value. Relaying is orderly and driven by chunk_id when processing data,
otherwise task_wid. Omitting the code block (e.g. MCE::relay) relays forward.
