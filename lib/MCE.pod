...
This document describes MCE version 1.499_005
...
MCE, spawn plus shutdown workers when script terminates.
...
run simultaneously with slight change in syntax.
...
and greps together through the use of User Tasks and MCE::Queue. Like with
MCE::Flow, MCE::Stream can run multiple code blocks simultaneously with
slight change in syntax from MCE::Map and MCE::Grep.
