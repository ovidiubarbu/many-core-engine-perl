...
This document describes MCE version 1.520
...
and max_workers for you. Spawning and shutdown is automatic. In essence, the
models take Many-Core Engine to a new level for ease of use.
