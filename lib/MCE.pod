...
This document describes MCE version 1.406
...
A sync operation in the example code means any worker must stop at this point
until all workers reach this barrier. Barrier syncing is useful for many
computer algorithms.

Barrier synchronization (sync) was added to MCE release 1.406.
...
=head2 INCLUDED with DISTRIBUTION
   ...
   matmult/matmult_pdl_b.pl, matmult_pdl_m.pl, strassen_pdl_m.pl
